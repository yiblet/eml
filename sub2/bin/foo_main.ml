(* Inspect the first command-line argument (Sys.argv.(1)) and determine which
   subcommand to execute, calling a function from our library accordingly. *)

open Printf

(* You can do anything you want. You may want to use Arg.parse_argv to read
